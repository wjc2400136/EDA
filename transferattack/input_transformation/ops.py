...
class OPS(Attack):
    ...
    def __init__(self, model_name, epsilon=16/255, beta=2., epoch=10, num_sample_neighbor=5, num_sample_operator=5,
                 sample_levels = range(2, 5), sample_ratios = np.arange(0., 1.5, 0.25) + 0.25, decay=1.,
                 targeted=False, random_start=False, norm='linfty', loss='crossentropy', device=None, attack='OPS',seed=42, **kwargs):
