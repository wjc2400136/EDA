...
class DEM(MIFGSM):
    ...
    Example script:
        python main.py --input_dir ./path/to/data --output_dir adv_data/dem/resnet50 --attack dem --model=resnet50
        python main.py --input_dir ./path/to/data --output_dir adv_data/dem/resnet50 --eval
