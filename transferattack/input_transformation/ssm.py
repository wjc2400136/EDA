...
class SSM(MIFGSM):
    ...
    Example script:
        python main.py --input_dir ./path/to/data --output_dir adv_data/ssm/resnet50 --attack ssm --model=resnet50
        python main.py --input_dir ./path/to/data --output_dir adv_data/ssm/resnet50 --eval
    """
