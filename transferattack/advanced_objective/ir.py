...
class IR(MIFGSM):
    ...
    Example script:
        python main.py --input_dir ./path/to/data --output_dir adv_data/ir/resnet50 --attack ir --model=resnet50
        python main.py --input_dir ./path/to/data --output_dir adv_data/ir/resnet50 --eval
    """
