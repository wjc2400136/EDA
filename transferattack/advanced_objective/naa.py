...
class NAA(MIFGSM):
    ...
    Example script:
        python main.py --input_dir ./path/to/data --output_dir adv_data/naa/resnet50 --attack naa --model=resnet50
        python main.py --input_dir ./path/to/data --output_dir adv_data/naa/resnet50 --eval
    """
