...
class SGM(MIFGSM):
    ...
    Example script:
        python main.py --input_dir ./path/to/data --output_dir adv_data/sgm/resnet50 --attack sgm --model=resnet50
        python main.py --input_dir ./path/to/data --output_dir adv_data/sgm/resnet50 --eval
    """
